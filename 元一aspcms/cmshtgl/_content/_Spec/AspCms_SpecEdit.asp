...
<TD><select name="SpecControlType" onChange="changeSpecControlType(this)" disabled>
...
<TD><textarea name="SpecOptions" id="SpecOptions" cols="50" rows="5" class="input" style="width:500px;height:80px;"><%=decode(SpecOptions)%></textarea>多条请用回车区别</TD>
<script type="text/javascript">
