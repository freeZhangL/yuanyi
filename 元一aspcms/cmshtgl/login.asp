...
<body>
	...
	<div class="main">
		<div class="login" style="height: 180px">
		<form method="post" action="?action=login" onsubmit="writeCookie('username',this.username.value, 1)">
            ...
            <dl>
			  ...
			  <dd  class="new">
                    <span style="font-family: 微软雅黑;color: #AAAAAA;">
                    <h1 style="margin-bottom: 16px;">书生商友后台管理</h1>
                    <p>服务热线：总部座机:0512-65729918(服务时间:9:00-17:00)</p>
	<p>全国24小时服务热线:4000-262-263，QQ：2950252031  </p>
	<p>邮箱:2950252031@qq.com</p>
	<p>总部官网:<a href="http://www.768800.com" target="_blank">www.768800.com</a></p>
	<p style="font-weight: bold; color: #F63;">友情提示：如网站增加资料，请及时联系我们进行备份，以免数据丢失</p></span>
	...
	<div class="copyright">
		Powered by <a href="http://www.768800.com">www.768800.com</a> Copyright &copy;2010-2015 
	</div>
